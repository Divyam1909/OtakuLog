...
export const DetailView: React.FC<DetailViewProps> = ({ item, libraryItem, onBack, onSave, onDelete }) => {
  ...
  return (
    <div className="relative min-h-screen bg-slate-950 pb-32 md:pb-20 animate-in fade-in duration-300">
        ...
        <div className="absolute top-6 left-6 z-50">
            <button 
                onClick={onBack} 
                className="group flex items-center gap-2 px-5 py-2.5 rounded-full bg-slate-900/40 hover:bg-slate-900/80 text-white backdrop-blur-md border border-white/10 hover:border-indigo-500/50 transition-all shadow-lg hover:shadow-indigo-500/20"
            >
